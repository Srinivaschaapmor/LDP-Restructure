...
- **MCP** — Model Context Protocol; how Claude connects to external tools. Currently Figma only
  (`figma-dev-mode`) — Contentful MCP was removed, see ADR-0009; content is modeled via
  `contentful-migration` CLI scripts instead.
